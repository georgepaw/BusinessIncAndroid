...
//    public ArrayList<String> cards = new ArrayList<String>();
    ...
    public TeamResultsData(){
        ...
        matches.add(new Match(1,1,1, "TeamA", "TeamB", 1, "Ref1", new GregorianCalendar(2006,11,1).getTime(), "Home", 8, 3, false));
        matches.add(new Match(1,1,1, "TeamB", "TeamC", 2, "Ref1", new GregorianCalendar(2006,11,9).getTime(), "Home", 1, 27, false));
        matches.add(new Match(1,1,1, "TeamB", "TeamD", 1, "Ref1", new GregorianCalendar(2006,11,4).getTime(), "Home", 19, 11, false));
        ...
        matches.add(new Match(1,1,1, "TeamA", "TeamB", 1, "Ref1", new GregorianCalendar(2006,11,1).getTime(), "Home", 9, 12, false));
