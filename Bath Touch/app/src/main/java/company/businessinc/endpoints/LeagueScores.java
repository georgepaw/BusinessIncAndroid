 ...
 */
public class LeagueScores extends AsyncTask<Void, Void, ResponseStatus> {
    ...
    public LeagueScores(LeagueScoresInterface callback, Context context, int leagueID) {
    ...
    protected ResponseStatus doInBackground(Void... a) {
        ...
        SQLiteManager.getInstance(context).bulkInsert(DBProviderContract.LEAGUESSCORE_TABLE_NAME, contentValues);
